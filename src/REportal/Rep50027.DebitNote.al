report 50027 "Debit Note"
{
    DefaultLayout = RDLC;
    RDLCLayout = './DebitNote.rdlc';
    Caption = 'Debit Note';
    ...
    dataset
    {
        dataitem(DataItem6640; Table36)
        {
            ...
            column(CurrencyCodeDesc; CurrencyCodeDesc)
            {
            }
            ...
            begin
                ...
                IF CurrencyRec.GET("Sales Header"."Currency Code") THEN
                  CurrencyCodeDesc := CurrencyRec.Description
                ELSE
                  CurrencyCodeDesc := '';
