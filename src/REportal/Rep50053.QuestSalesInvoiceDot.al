report 50053 "Quest Sales Invoice Dot"
{
    DefaultLayout = RDLC;
    RDLCLayout = './QuestSalesInvoiceDot.rdlc';
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    dataitem(DataItem1570; Table113)
                    {
                        ...
                        column(ExpiyDate_SalesInvoiceLine; FORMAT(BatchInfo."Expiry Date"))
                        {
                        }
    ...
    begin
        WITH SalesInvoiceLine DO BEGIN
            ...
            IF BatchInfo.GET(TempItemLedgEntry."Item No.", TempItemLedgEntry."Variant Code", TempItemLedgEntry."Lot No.") THEN;
