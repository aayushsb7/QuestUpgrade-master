report 50062 "Quest Sales Invoice Dot 1.2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './QuestSalesInvoiceDot12.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5581; Table112)
        {
            ...
            column(SameCustomer; SameCustomer)
            {
            }
            ...
            column(Issuing_Bank; LC_Detail."Issue Bank Name1")
            {
            }
            column(Date_of_Issue; FORMAT(LC_Detail."Date of Issue"))
            {
            }
            ...
            column(InvDiscAmt; "Sales Invoice Header"."Invoice Discount Amount")
            {
            }
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    dataitem(DataItem1570; Table113)
                    {
                        ...
                        column(PostedShipmentDates; FORMAT(PostedShipmentDate))
                        {
                        }
                        ...
                        column(ExpiyDate_SalesInvoiceLine; ExpiryDateText)
                        {
                        }
                        column(BatchNo_SalesInvoiceLine; BatchInfo."Lot No.")
                        {
                        }
                        column(ManufacturingDate_SalesInvoiceLine; FORMAT(BatchInfo."Manufacturing Date"))
                        {
                        }
                        ...
                        trigger OnAfterGetRecord()
                        begin
                            IF "Prepayment Line" OR (Quantity = 0) THEN
                                CurrReport.SKIP;
                    ...
                    dataitem(DataItem188; Table110)
                    {
                        DataItemLink = Order No.=FIELD(Order No.);
                        DataItemLinkReference = "Sales Invoice Header";
                        dataitem(DataItem206; Table111)
                        {
                            DataItemLink = Document No.=FIELD(No.);
                            ...
                            column(FreeQuantityShipt; FreeQuantity)
                            {
                            }
                            dataitem(DataItem189; Table32)
                            {
            ...
            begin
                ...
                IF ("Sales Invoice Header"."Document Profile" = "Sales Invoice Header"."Document Profile"::"Vehicles Trade") OR
                    ("Sales Invoice Header"."Document Profile" = "Sales Invoice Header"."Document Profile"::" ") THEN BEGIN
                    IF ("Sales Invoice Header"."Bill-to Customer No." = "Sales Invoice Header"."Sell-to Customer No.")
                          THEN
                        SameCustomer := TRUE
                    ELSE
                        SameCustomer := FALSE;
    ...
    var
        SalesInvoiceHeader: Record "112";
    begin
        IF CompanyInfo."IRD Approval" THEN BEGIN
            IF NOT CurrReport.PREVIEW THEN BEGIN
            ...
            IF ("Sales Invoice Header"."No. Printed" > 4) THEN BEGIN
                ...
                TimesPrintedCaption := TimesPrintedCaptionlbl + FORMAT("Sales Invoice Header"."No. Printed" - 4);
            END;
            IF NOT CurrReport.PREVIEW THEN
                SalesInvCountPrinted.RUN("Sales Invoice Header");
        END ELSE BEGIN
            InvoiceCaption := EstimateCaptionlbl;
        END;
    end;
    ...
    begin
        WITH SalesInvoiceLine DO BEGIN
            ...
            IF BatchInfo.GET(TempItemLedgEntry."Item No.", TempItemLedgEntry."Variant Code", TempItemLedgEntry."Lot No.") THEN BEGIN
                ExpiryDateText := IRDMgt.GetExpiryDateInText(BatchInfo."Expiry Date");
            END;
    ...
    var
        Contact: Record "5050";
    begin
        IF CompanyInfo."IRD Approval" THEN BEGIN //MIN 12/2/2019
