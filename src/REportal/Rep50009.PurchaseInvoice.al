report 50009 "Purchase Invoice"
{
    ...
    dataset
    {
        dataitem(DataItem3733; Table122)
        {
            ...
            column(DocumentDate; FORMAT("Purch. Inv. Header"."Document Date") + '  ( ' + SystemManagement.getNepaliDate("Purch. Inv. Header"."Document Date") + ' )')
            {
            }
            column(SysLCNo_PurchInvHeader; "Purch. Inv. Header"."Sys. LC No.")
            {
            }
    ...
    var
        ...
        Currency: Record "4";
        "---NP15.1001": ;
        DocumentCaptionLbl: Label 'PURCHASE VOUCHER';
        TotalTDSAmt: Decimal;
        PragyaPanPatra: Code[10];
    ...
    local procedure PurchInvLineOnAfterGetRecord(PurchInvLine: Record "123")
    begin
