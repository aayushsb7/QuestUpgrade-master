report 50013 "Sales Order"
{
    ...
    dataset
    {
        dataitem(DataItem6640; Table36)
        {
            ...
            column(Bill_To_Name2; "Sales Header"."Bill-to Name 2")
            {
            }
            ...
            column(Bank_LC_No; "Sales Header"."Bank LC No.")
            {
            }
            column(FinancedByName; FinancedByName)
            {
            }
            column(GlobalExecTime; GlobalExecTime)
            {
            }
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(FinanceByAddress; FinanceByAddress)
                    {
                    }
                    ...
                    dataitem(RoundLoop;Table2000000026)
                    {
                        ...
                        column(MRP;"Sales Line"."Maximum Retail Price")
                        {
                        }
                        ...
                        column(FreeItemLine;"Sales Line"."Free Item Line")
                        {
                        }
                        ...
                        column(ManufacturingDate;FORMAT(LotInfo."Manufacturing Date"))
                        {
                        }
                        column(BatchNo;LotInfo."Lot No.")
                        {
                        }
            ...
            begin
                ...
                IF Print THEN BEGIN
                  ...
                  END;
                END;
                GlobalExecTime := CURRENTDATETIME;
            end;
    ...
    begin
        ...
        END ELSE BEGIN
          IF AccCenter.GET("Sales Header"."Accountability Center") THEN BEGIN
            CompanyOneLineAddress := AccCenter.Address;
            CompanyCommunicationAddress := 'Tel No. : ' + AccCenter."Phone No.";
            IF (CompanyCommunicationAddress <> '') AND (CompanyInfo."E-Mail" <> '') THEN
              CompanyCommunicationAddress += ', ' + AccCenter.FIELDCAPTION("E-Mail") + ' : ' + AccCenter."E-Mail";
            CompanyInfoVATRegNo := 'PAN Number'+ ' : '+CompanyInfo."VAT Registration No.";
          END;
        END;
    end;
    ...
    var
        ...
        SalesLineReserver: Codeunit "99000832";
        ReservEntr: Record "337";
        IRDMgt: Codeunit "50000";
    begin
        WITH SalesLine DO BEGIN
          IF ("No." <> '') AND (NOT "Free Item Line") THEN
            SalesLineSN  += 1;
          ...
          ExpiryDateText := '';
          LotInfo.RESET;
          IF SalesLineReserver.FindReservEntry(SalesLine,ReservEntr) THEN BEGIN
            IF LotInfo.GET(ReservEntr."Item No.",ReservEntr."Variant Code",ReservEntr."Lot No.") THEN BEGIN
              ExpiryDateText := IRDMgt.GetExpiryDateInText(LotInfo."Expiry Date");
            END;
        //    MESSAGE(LotInfo."Lot No.");
        //    MESSAGE(FORMAT(LotInfo."Manufacturing Date"));
        //    MESSAGE(FORMAT(LotInfo."Expiry Date"));
          END;
          ...
          IF Type = Type::Item THEN BEGIN
            ...
            FreeSalesLine.SETRANGE("No.","No.");
            FreeSalesLine.SETRANGE("Sales Line No.","Line No.");
            IF FreeSalesLine.FINDFIRST THEN
              FreeQuantity := FreeSalesLine.Quantity;
          END;
        END;
    end;
}
