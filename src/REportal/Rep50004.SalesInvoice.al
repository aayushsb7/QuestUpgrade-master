report 50004 "Sales Invoice"
{
    ...
    dataset
    {
        dataitem(DataItem5581; Table112)
        {
            ...
            column(CompanyInfoVATRegNo; 'PAN Number' + ' : ' + CompanyInfo."VAT Registration No.")
            {
            }
            ...
            column(DispatchDate_SalesInvoiceHeader; "Sales Invoice Header"."Dispatch Date")
            {
            }
            column(TransportName_SalesInvoiceHeader; "Sales Invoice Header"."Transport Name")
            {
            }
            column(CNNo_SalesInvoiceHeader; "Sales Invoice Header"."CN No.")
            {
            }
    ...
    begin
        IF CompanyInfo."IRD Approval" THEN BEGIN //MIN 12/2/2019
            IF NOT CurrReport.PREVIEW THEN BEGIN  //MIN 12/2/2019
        ...
        END ELSE BEGIN
            InvoiceCaption := InvoiceCaptionlbl; //MIN 12/2/2019
        END;
    end;
