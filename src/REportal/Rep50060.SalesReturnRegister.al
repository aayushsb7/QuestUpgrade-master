report 50060 "Sales Return  Register"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesReturnRegister.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1; Table50001)
        {
            ...
            begin
                ...
                SalesCrmemoLine.SETRANGE("Document No.", "Invoice Materialize View"."Bill No");
                IF SalesCrmemoLine.FINDFIRST THEN
                    REPEAT
                        TotalQuantity += SalesCrmemoLine.Quantity;
                        ProductDiscount += SalesCrmemoLine."Line Discount Amount";
