report 50011 "Posted Voucher"
{
    ...
    dataset
    {
        dataitem("G/L Entry"; Table17)
        {
            ...
            column(NepaliDocumentDate_GLEntry; "G/L Entry"."Nepali Document Date")
            {
            }
    ...
    [Scope('Internal')]
    procedure GetDescription("Source Type": Option " ",Customer,Vendor,"Bank Account","Fixed Asset",Employee; "Entry No.": Integer; "Source No.": Code[20]; "G/L Account No.": Code[20]): Text[50]
    var
        Description: Text[50];
    begin
        IF "Source Type" = "Source Type"::Vendor THEN BEGIN
